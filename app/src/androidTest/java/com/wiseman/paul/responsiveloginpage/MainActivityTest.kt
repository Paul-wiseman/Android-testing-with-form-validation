...
class MainActivityTest {
     ...
     * the form field are first filled with input from the companion object above
     * the test logs in the user info and compares if the input matches with what is displayed on successful log in
     */
    @Test
